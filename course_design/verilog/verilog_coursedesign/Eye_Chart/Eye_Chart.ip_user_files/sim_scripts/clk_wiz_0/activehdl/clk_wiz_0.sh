...
#
# Script generated by Vivado on Fri Jun 23 00:36:55 +0800 2023
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/develop/code/course_design/verilog/verilog_coursedesign/Eye_Chart/Eye_Chart.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
