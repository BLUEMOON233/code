...
REM
REM Generated by Vivado on Wed May 10 10:41:42 +0800 2023
...
echo "xvlog --incr --relax -prj mux21_simulation_vlog.prj"
call xvlog  --incr --relax -prj mux21_simulation_vlog.prj -log xvlog.log
