...
REM
REM Generated by Vivado on Wed May 10 12:14:34 +0800 2023
...
echo "xvlog --incr --relax -prj mux41_simulation_vlog.prj"
call xvlog  --incr --relax -prj mux41_simulation_vlog.prj -log xvlog.log
