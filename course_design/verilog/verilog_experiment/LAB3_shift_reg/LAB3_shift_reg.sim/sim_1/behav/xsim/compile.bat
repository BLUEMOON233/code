...
REM
REM Generated by Vivado on Wed May 17 23:14:39 +0800 2023
...
echo "xvlog --incr --relax -prj shift_reg_simulation_vlog.prj"
call xvlog  --incr --relax -prj shift_reg_simulation_vlog.prj -log xvlog.log
